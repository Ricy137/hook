...
//TODO: react-form-hooks, it's just UI now
  ...
  return (
    <div className={cx("relative", wrapperClass)}>
      <div
        ...
        {...getReferenceProps()}
        className={cx(
          "pl-12px pr-7px flex items-center justify-between w-240px h-32px text-14px leading-22px rounded-8px border-#DCDEE0 border-1px border-solid focus:border-#000000 hover:border-#000000 box-border cursor-pointer",
      ...
      {isOpen && (
        <div
          className="w-full rounded-2px shadow-[0px_2px_8px_0px_rgba(0,0,0,0.12)] z-100"
        ...
        >
          {options.map((option) => (
            <div
              key={option.value}
              className="pl-12px flex items-center w-full h-32px text-14px leading-22px text-#000000 bg-#FFFFFF hover:bg-#FFF6ED cursor-pointer"
